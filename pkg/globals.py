...
col_drop = [
    'DSANTREG', 'CFPAGODERECHOS_LLOFICINA', 'FULTLOGIN', 'DSCORREO',
    'BLFOTO', 'DSADSCRIPCION', 'DSCONTRASENIA', 'DSACTO_MVFRMACTO',
...
col_str = ['DSDENSOCIAL', 'DSDIRECCION', 'DSDURACION', 'DSNOMBRESOCIO', 'DSRFC',
           ...
           'FCINSCRIPCION', 'DSNOMBRERESP', 'FCINIOPERACION', 'CRFME', 'FCNACIMIENTO']
